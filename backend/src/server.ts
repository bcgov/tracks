...
import {tenureBindings} from './apis/admin/tenure_bindings';
...
const app = express()
	...
	.get(`${prefix}/admin/tenure_bindings`, jwks.protect({
		requireRole: 'admin',
		requireOrganizationMapping: true
	}), tenureBindings.bindingRequests)

	.post(`${prefix}/admin/tenure_bindings`, jwks.protect({
		requireRole: 'admin',
		requireOrganizationMapping: true
	...
	.post(`${prefix}/operator/tenure_bindings`, jwks.protect({
		requireRole: 'commercial_operator',
		requireOrganizationMapping: true
	}), operatorTenures.request_binding)

	.get(`${prefix}/operator/tenure_bindings`, jwks.protect({
		requireRole: 'commercial_operator',
		requireOrganizationMapping: true
	}), operatorTenures.binding_requests)
